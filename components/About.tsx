...
import OrganizationJsonLd from "@/components/OrganizationJsonLd"; // New Import
...
export default function About() {
  ...
  return (
    <>
      <OrganizationJsonLd teamMembers={team} />
      <section id="about" className="py-20 max-w-7xl mx-auto px-4">
        ...
        >
          ...
          sustainable performance. We work with ambitious organisations across
          the UK and beyond to unlock sustainable performance.
        </p>
